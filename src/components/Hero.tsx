    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          {/* Left - Profile Image */}
          <div className="flex justify-center lg:justify-start animate-fade-in order-2 lg:order-1" style={{ animationDelay: "0.3s" }}>
            <div className="relative">
              ...
              <div className="absolute -bottom-2 -right-2 w-6 h-6 bg-primary/60 rounded-full animate-float" style={{ animationDelay: "0.5s" }} />
              <div className="absolute top-1/2 -left-8 w-4 h-4 bg-primary/40 rounded-full animate-float" style={{ animationDelay: "1s" }} />
            </div>
          </div>
          ...
          <div className="space-y-8 text-center lg:text-right order-1 lg:order-2">
            <div className="space-y-4">
              ...
              <div className="h-12 flex items-center justify-center lg:justify-end" style={{ animationDelay: "0.2s" }}>
            ...
            <p className="text-muted-foreground text-lg max-w-lg mx-auto lg:ml-auto lg:mr-0 animate-fade-in" style={{ animationDelay: "0.3s" }}>
            ...
            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-end animate-fade-in" style={{ animationDelay: "0.4s" }}>
              <Button
                size="lg"
            ...
            {/* Social Links */}
            <div className="flex gap-4 justify-center lg:justify-end animate-fade-in" style={{ animationDelay: "0.5s" }}>
              <a
